//
//  HMPrivacyPolicyViewController.m
//  Homage
//
...
@interface HMPrivacyPolicyViewController ()
...
@implementation HMPrivacyPolicyViewController
...
-(void)initContent
{
    ...
    NSString *fPath = [[NSBundle mainBundle] pathForResource:@"LabelPrivacyPolicy" ofType:@"txt"];
