...
-(void)updateNavButtonForNavController:(UINavigationController *)navVC
{
    ...
    {
        [self.guiNavButton setImage:[UIImage imageNamed:@"back"] forState:UIControlStateNormal];
        self.guiNavButton.tag = BACK_TAG;
    } else
    {
        [self.guiNavButton setImage:[UIImage imageNamed:@"settings"] forState:UIControlStateNormal];
